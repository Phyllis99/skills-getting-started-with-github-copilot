...
activities = {
    ...
    "Soccer Team": {
        "description": "Practice team drills and compete in school matches",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["liam@mergington.edu", "noah@mergington.edu"]
    },
    "Swimming Club": {
        "description": "Swim training and water fitness activities",
    ...
    "Math Olympiad": {
        "description": "Train for math competitions with challenging problem solving",
        "schedule": "Mondays, 5:00 PM - 6:30 PM",
        "max_participants": 14,
        "participants": ["lucas@mergington.edu", "ethan@mergington.edu"]
    },
    "Science Bowl": {
        "description": "Prepare for science quiz competitions across all disciplines",
